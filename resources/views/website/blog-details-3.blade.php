          ...
          <div class="cs-sidebar_item">
            ...
            <ul class="cs-recent_posts">
              <li>
                <div class="cs-recent_post">
                  <a href="#" class="cs-recent_post_thumb">
                    <div class="cs-recent_post_thumb_in cs-bg" data-src="{{ asset('website/assets/img/online-education/post1.jpg') }}"></div>
                  </a>
              ...
              <li>
                <div class="cs-recent_post">
                  <a href="#" class="cs-recent_post_thumb">
                    <div class="cs-recent_post_thumb_in cs-bg" data-src="{{ asset('website/assets/img/online-education/post2.jpg') }}"></div>
                  </a>
                  <div class="cs-recent_post_info">
              ...
              <li>
                <div class="cs-recent_post">
                  <a href="#" class="cs-recent_post_thumb">
                    <div class="cs-recent_post_thumb_in cs-bg"  data-src="{{ asset('website/assets/img/online-education/post3.jpg') }}"></div>
                  </a>
                  <div class="cs-recent_post_info">
                    <div class="cs-recent_post_date cs-primary_40_color">12 Feb, 2022</div>
