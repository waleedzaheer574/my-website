...
class ServiceDetailController extends Controller
{
    ...
    protected function validateDetail(Request $request, ?ServiceDetail $serviceDetail = null): array
    {
        return $request->validate([
            ...
            'title_prefix_ar' => 'nullable|string|max:255',
            ...
            'process_heading_ar' => 'nullable|string|max:255',
            'process_one_title' => 'nullable|string|max:255',
            'process_one_title_ar' => 'nullable|string|max:255',
            'process_one_text' => 'nullable|string',
            'process_one_text_ar' => 'nullable|string',
            'process_two_title' => 'nullable|string|max:255',
            'process_two_title_ar' => 'nullable|string|max:255',
            'process_two_text' => 'nullable|string',
            'process_two_text_ar' => 'nullable|string',
            'process_three_title' => 'nullable|string|max:255',
            'process_three_title_ar' => 'nullable|string|max:255',
            'process_three_text' => 'nullable|string',
            'process_three_text_ar' => 'nullable|string',
